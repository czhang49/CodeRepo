 ...
 *
 * @param lhs Vector2 to subtract from
 * @param rhs Vector2 to subtract by
 *
...
/**
 * Multiples the current Vector2 by a scalar and returns a new Vector2 with
 * its value
 *
 * @param lhs Vector2 to multiply
 * @param constant to multiply by
 *
 * @return a new Vector2 that equals (x * constant, y * constant)
 */
Vector2 operator*(const Vector2& lhs, int constant);
 ...
 * @return a new Vector2 that equals (x * constant, y * constant)
 */
Vector2 operator*(int constant, const Vector2& rhs);

/**
 * Divides the current Vector2 by a scalar and returns a new Vector2 with
 * its value
 *
 * @param lhs Vector2 to divide
