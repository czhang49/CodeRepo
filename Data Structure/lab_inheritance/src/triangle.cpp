...
Triangle::Triangle(const epng::rgba_pixel& pcolor, const Vector2& vertex1,
...
Triangle::Triangle(Triangle&& other) : vertices_{nullptr}
{
    swap(other);
}
...
void Triangle::draw(epng::png& canvas) const
{
    /* Code taken from
