...
Line::Line(const Vector2& pa, const Vector2& pb, const epng::rgba_pixel& pcolor)
    : a_{pa}, b_{pb}, color_{pcolor}
{
    /* Nothing see initialization list. */
}

void Line::draw(epng::png& canvas) const
{
    /* http://gabrielongraphics.blogspot.com/2005/09/drawing-line-segments.html
     */
...
epng::rgba_pixel Line::color() const
{
    return this->color_;
}

void Line::set_color(const epng::rgba_pixel& pcolor)
{
    this->color_ = pcolor;
}
