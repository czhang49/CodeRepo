...
#if !defined(__CUDACC__) && defined(__x86_64) && __GNUC__ >= 4 && __GNUC_MINOR__ >= 6
#define GCC_INT128
#endif
...
public:
  ...
  HD Int128 operator + (Int128 x) {
    ...
    result.word2() = word2() + x.word2() + ((result.word0() < word0()) ? result.word1() <= word1() : result.word1() < word1());
    result.word3() = word3() + x.word3() + (((result.word0() < word0()) ? result.word1() <= word1() : result.word1() < word1()) ? result.word2() <= word2() : result.word2() < word2());
    */
  ...
  __device__ static void mult128lo_asm(Int128 a, Int128 b, Int128 &result_lo) {
    ...
    asm( "{\n\t"
	 ...
	 "mad.lo.u32       %3, %7, %8, %3;\n\t"
	 "}\n\t"
	 : "=r"(result_lo.word0()), "=r"(result_lo.word1()), "=r"(result_lo.word2()), "=r"(result_lo.word3())
	 : "r"(a.word0()), "r"(a.word1()), "r"(a.word2()), "r"(a.word3()),
	   "r"(b.word0()), "r"(b.word1()), "r"(b.word2()), "r"(b.word3())
	 );
  ...
  __device__ static void mult128hi_asm(Int128 a, Int128 b,
    ...
    asm( "{\n\t"
	 ...
	 "}\n\t"
	 : "=r"(result_hi.word0()), "=r"(result_hi.word1()), "=r"(result_hi.word2()), "=r"(result_hi.word3())
	 : "r"(a.word0()), "r"(a.word1()), "r"(a.word2()), "r"(a.word3()),
	   "r"(b.word0()), "r"(b.word1()), "r"(b.word2()), "r"(b.word3())
	 );
  }
  ...
  */
  HD static void mult128(Int128 a, Int128 b,
    ...
    result_lo.setPart1(CudaPiMath::addCarryOut64
		       (result_lo.getPart1(), tmp.getPart0(), carry));
    result_hi.setPart0(CudaPiMath::addCarryInOut64
		       (result_hi.getPart0(), tmp.getPart1(), carry));
    result_hi.setPart1(CudaPiMath::addCarryIn64
...
#define MONTGOMERY_INT128 Int128
  ...
  HD static u64 montgomeryMult(u64 factor1, u64 factor2,
			       u64 m, u64 minv, u64 mask, int s) {
 ...
 public:
  ...
  HD static u64 modPow2(u64 exponent, u64 modulo) {
    ...
    Int128 result = 2;
    for (u64 bit = CudaPiMath:: highestSetBit64(exponent) >> 1;
	 bit > 0;
	 bit >>= 1) {
      result = result * result;
      if (result >= modulo) result = result % modulo;
      if (exponent & bit) {
	result <<= 1;
	if (result >= modulo) result = result - modulo;
      }
