...
/*
   ...
   It it set to STDERR_FILENO by default.
...
void threadStatusSetInternal(const char *description, const char *src_filename, int src_line); 
/*
   The macros below wrap thread syncronization function that may block
